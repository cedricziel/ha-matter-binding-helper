      ...
      <li>
        ...
        >
          ...
          <div class="node-info">
            ...
            ${o?.vendor_name?I`<span class="node-vendor">${o.vendor_name}</span>`:W}
          </div>
          <small>
