 ...
 */function le(e){return ce({...e,state:!0,attribute:!1})}const pe=3,ge=4,he=5,ue=6,_e=8,me=29,ve=30,be=31,fe=40,ye=47,$e=768,xe=513,we=516,Ae=1026,Se=1027,Ee=1029,Ce=1030,Te={[pe]:"Identify",[ge]:"Groups",[he]:"Scenes",[ue]:"On/Off",[_e]:"Level Control",[me]:"Descriptor",[ve]:"Binding",[be]:"Access Control",[fe]:"Basic Information",42:"OTA Update",[ye]:"Power Source",48:"General Commissioning",49:"Network Commissioning",50:"Diagnostic Logs",51:"General Diagnostics",52:"Software Diagnostics",53:"Thread Diagnostics",56:"Ethernet Diagnostics",60:"Admin Commissioning",62:"Operational Credentials",63:"Group Key Management",70:"Time Sync",[$e]:"Color Control",[xe]:"Thermostat",[we]:"Thermostat UI",514:"Fan Control",[Ae]:"Temperature",[Se]:"Pressure",[Ee]:"Humidity",[Ce]:"Occupancy"},ke={17:"Power Source",18:"OTA Requestor",19:"OTA Provider",20:"Aggregator",22:"Root Node",256:"On/Off Light",257:"Dimmable Light",258:"Color Temperature Light",259:"On/Off Light Switch",260:"Dimmer Switch",261:"Color Dimmer Switch",262:"Light Sensor",263:"Occupancy Sensor",266:"On/Off Plug-in Unit",267:"Dimmable Plug-in Unit",268:"Color Temperature Light",269:"Extended Color Light",769:"Thermostat",770:"Temperature Sensor",771:"Humidity Sensor",772:"Air Quality Sensor",10:"Door Lock",11:"Door Lock Controller",514:"Window Covering",515:"Window Covering Controller",21:"Contact Sensor",38:"Flow Sensor",44:"Smoke/CO Alarm",35:"Casting Video Player",36:"Content App",40:"Basic Video Player",41:"Casting Video Client",43:"Speaker"},Ne={[ue]:{action:"control the on/off state of",dataType:"on/off commands"},[_e]:{action:"control the brightness/level of",dataType:"level/dimming commands"},[$e]:{action:"control the color of",dataType:"color commands"},[Ae]:{action:"read temperature data from",dataType:"temperature readings"},[Se]:{action:"read pressure data from",dataType:"pressure readings"},[Ee]:{action:"read humidity data from",dataType:"humidity readings"},[Ce]:{action:"receive occupancy status from",dataType:"occupancy/presence data"},[xe]:{action:"control thermostat settings on",dataType:"thermostat commands"},[he]:{action:"trigger scenes on",dataType:"scene commands"},[ge]:{action:"manage group membership on",dataType:"group commands"}};function De(e){return Te[e]||`0x${e.toString(16).padStart(4,"0")}`}function Be(e){return ke[e]||`Type ${e}`}function Pe(e){return Ne[e]||{action:"communicate with",dataType:`${De(e)} data`}}const Oe=[{id:"thermostat-contact-window",sourceDeviceTypes:[769],targetDeviceTypes:[21],title:"Turn off heating when window opens",description:"Automatically pause heating/cooling when a window or door is opened to save energy.",why:"This thermostat doesn't have a client cluster for Boolean State (contact sensors). Matter bindings require matching client/server clusters.",icon:"🪟"},{id:"thermostat-occupancy",sourceDeviceTypes:[769],targetDeviceTypes:[263],title:"Adjust temperature based on occupancy",description:"Lower the temperature when room is unoccupied, restore when someone enters.",why:"This thermostat doesn't have a client cluster for Occupancy Sensing. A Home Assistant automation can bridge this gap.",icon:"🚶"},{id:"light-occupancy",sourceDeviceTypes:[256,257,258,268,269],targetDeviceTypes:[263],title:"Turn on light when motion detected",description:"Automatically turn on lights when someone enters the room.",why:"This light is a server (receives commands), not a client. The occupancy sensor reports state but can't send on/off commands to it.",icon:"💡"},{id:"light-contact-door",sourceDeviceTypes:[256,257,258,268,269],targetDeviceTypes:[21],title:"Turn on light when door opens",description:"Automatically turn on lights when a door is opened (e.g., closet light).",why:"This contact sensor reports open/close state but doesn't have client clusters to control lights directly.",icon:"🚪"},{id:"plug-occupancy",sourceDeviceTypes:[266,267],targetDeviceTypes:[263],title:"Control device based on occupancy",description:"Turn on/off a device when room occupancy changes.",why:"This plug is a server (receives commands). The occupancy sensor can't directly control it via Matter binding.",icon:"🔌"}],Re="matter_binding_helper";async function ze(e,t,i){return e.callWS({type:`${Re}/list_bindings`,node_id:t,endpoint_id:i})}async function Ie(e,t,i,n,o,s,r){return e.callWS({type:`${Re}/create_binding`,source_node_id:t,source_endpoint_id:i,cluster_id:n,...void 0!==o&&{target_node_id:o},...void 0!==s&&{target_endpoint_id:s},...void 0!==r})}async function Ue(e,t,i,n,o,s){return e.callWS({type:`${Re}/delete_binding`,source_node_id:t,source_endpoint_id:i,...void 0!==n&&{target_node_id:n},...void 0!==o&&{target_endpoint_id:o},...void 0!==s&&{target_group_id:s}})}let Me=class extends se{constructor(){super(...arguments),this.narrow=!1,this._nodes=[],this._selectedSourceNode=null,this._selectedSourceEndpoint=null,this._bindings=[],this._groups=[],this._loading=!1,this._error=null,this._activeTab="overview",this._showCreateDialog=!1,this._allBindings=[],this._recommendations=[],this._overviewLoading=!1,this._surveySubmitting=!1,this._selectedTargetNodeId=null,this._selectedTargetEndpointId=null,this._filterSameAreaOnly=!0,this._actionInProgress=null,this._pendingBindingRecommendation=null,this._selectedClusterForBinding=null,this._pendingDeleteBinding=null,this._automationRecommendations=[]}firstUpdated(){this._loadNodes().then(()=>{"overview"===this._activeTab&&this._loadOverviewData()})}async _loadNodes(){this._loading=!0,this._error=null;try{const e=await async function(e){return e.callWS({type:`${Re}/list_nodes`})}(this.hass);this._nodes=e.nodes}catch(e){this._error=`Failed to load nodes: ${e}`}finally{this._loading=!1}}async _loadBindings(){if(this._selectedSourceNode&&this._selectedSourceEndpoint){this._loading=!0;try{const e=await ze(this.hass,this._selectedSourceNode.node_id,this._selectedSourceEndpoint.endpoint_id);this._bindings=e.bindings}catch(e){this._error=`Failed to load bindings: ${e}`}finally{this._loading=!1}}}async _loadGroups(){this._loading=!0;try{const e=await async function(e){return e.callWS({type:`${Re}/list_groups`})}(this.hass);this._groups=e.groups}catch(e){this._error=`Failed to load groups: ${e}`}finally{this._loading=!1}}async _loadOverviewData(){this._overviewLoading=!0,this._error=null;try{const e=[];for(const t of this._nodes)for(const i of t.endpoints)if(i.has_binding_cluster)try{const n=await ze(this.hass,t.node_id,i.endpoint_id);for(const o of n.bindings){const n=o.target_node_id&&this._nodes.find(e=>e.node_id===o.target_node_id)||null,s=n&&o.target_endpoint_id&&n.endpoints.find(e=>e.endpoint_id===o.target_endpoint_id)||null;e.push({binding:o,sourceNode:t,sourceEndpoint:i,targetNode:n,targetEndpoint:s})}}catch{}this._allBindings=e,this._recommendations=this._computeRecommendations(),this._automationRecommendations=this._computeAutomationRecommendations()}catch(e){this._error=`Failed to load overview data: ${e}`}finally{this._overviewLoading=!1}}_computeAutomationRecommendations(){const e=[],t=new Set;for(const i of this._nodes)for(const n of i.endpoints){const o=n.device_types.map(e=>e.id);for(const s of this._nodes)if(!i.area_name||!s.area_name||i.area_name===s.area_name)for(const r of s.endpoints){if(i.node_id===s.node_id)continue;const a=r.device_types.map(e=>e.id);for(const d of Oe){const c=d.sourceDeviceTypes.some(e=>o.includes(e)),l=d.targetDeviceTypes.some(e=>a.includes(e));if(c&&l){const o=`${d.id}-${i.node_id}-${s.node_id}`;if(t.has(o))continue;t.add(o),e.push({template:d,sourceNode:i,sourceEndpoint:n,targetNode:s,targetEndpoint:r})}}}}return e}_computeRecommendations(){const e=[];for(const t of this._nodes)for(const i of t.endpoints){const n=i.client_clusters||[];if(0===n.length||!i.has_binding_cluster)continue;const o=this._allBindings.filter(e=>e.binding.node_id===t.node_id&&e.binding.endpoint_id===i.endpoint_id).map(e=>e.binding.cluster_id);for(const s of this._nodes)for(const r of s.endpoints){if(t.node_id===s.node_id&&i.endpoint_id===r.endpoint_id)continue;const a=r.server_clusters||[],d=n.filter(e=>a.includes(e));if(0===d.length)continue;const c=d.filter(e=>!o.includes(e));if(0===c.length)continue;const l=this._allBindings.some(e=>e.binding.node_id===t.node_id&&e.binding.endpoint_id===i.endpoint_id&&e.binding.target_node_id===s.node_id&&e.binding.target_endpoint_id===r.endpoint_id);l||e.push({sourceNode:t,sourceEndpoint:i,targetNode:s,targetEndpoint:r,compatibleClusters:c})}}return e.sort((e,t)=>t.compatibleClusters.length-e.compatibleClusters.length),e}_selectNode(e){this._selectedSourceNode?.node_id===e.node_id?(this._selectedSourceNode=null,this._selectedSourceEndpoint=null,this._bindings=[]):(this._selectedSourceNode=e,this._selectedSourceEndpoint=null,this._bindings=[])}_selectEndpoint(e,t){e.stopPropagation(),t.has_binding_cluster&&(this._selectedSourceEndpoint=t,this._loadBindings())}async _deleteBinding(e){if(!confirm("Are you sure you want to delete this binding?"))return;const t=`delete-tab-${e.node_id}-${e.endpoint_id}-${e.target_node_id}-${e.target_endpoint_id}`;this._actionInProgress=t;try{await Ue(this.hass,e.node_id,e.endpoint_id,e.target_node_id??void 0,e.target_endpoint_id??void 0,e.target_group_id??void 0),await this._loadBindings()}catch(e){this._error=`Failed to delete binding: ${e}`}finally{this._actionInProgress=null}}_openCreateDialog(){const e=this._nodes.filter(e=>e.node_id!==this._selectedSourceNode?.node_id);if(e.length>0){this._selectedTargetNodeId=e[0].node_id;const t=e[0],i=t.endpoints.filter(e=>e.server_clusters&&e.server_clusters.length>0);this._selectedTargetEndpointId=i.length>0?i[0].endpoint_id:t.endpoints[0]?.endpoint_id??null}this._showCreateDialog=!0}_closeCreateDialog(){this._showCreateDialog=!1,this._selectedTargetNodeId=null,this._selectedTargetEndpointId=null}_handleTargetNodeChange(e){const t=e.target;this._selectedTargetNodeId=parseInt(t.value,10);const i=this._nodes.find(e=>e.node_id===this._selectedTargetNodeId);if(i){const e=i.endpoints.filter(e=>e.server_clusters&&e.server_clusters.length>0);this._selectedTargetEndpointId=e.length>0?e[0].endpoint_id:i.endpoints[0]?.endpoint_id??null}}_handleTargetEndpointChange(e){const t=e.target;this._selectedTargetEndpointId=parseInt(t.value,10)}_getCompatibleClusters(){if(!this._selectedSourceEndpoint||!this._selectedTargetNodeId||!this._selectedTargetEndpointId)return[];const e=this._nodes.find(e=>e.node_id===this._selectedTargetNodeId),t=e?.endpoints.find(e=>e.endpoint_id===this._selectedTargetEndpointId);if(!t)return[];const i=this._selectedSourceEndpoint.client_clusters||[],n=t.server_clusters||[];return i.filter(e=>n.includes(e))}async _handleCreateBinding(e){e.preventDefault();const t=e.target,i=new FormData(t),n=parseInt(i.get("targetNode"),10),o=parseInt(i.get("targetEndpoint"),10),s=parseInt(i.get("cluster"),10);if(!this._selectedSourceNode||!this._selectedSourceEndpoint)return;const r=this._selectedSourceEndpoint.client_clusters||[],a=this._nodes.find(e=>e.node_id===n),d=a?.endpoints.find(e=>e.endpoint_id===o),c=d?.server_clusters||[];if(r.includes(s))if(c.includes(s))try{await Ie(this.hass,this._selectedSourceNode.node_id,this._selectedSourceEndpoint.endpoint_id,s,n,o),this._closeCreateDialog(),await this._loadBindings()}catch(e){this._error=`Failed to create binding: ${e}`}else this._error=`Target endpoint does not have cluster ${De(s)} as a server cluster`;else this._error=`Source endpoint does not have cluster ${De(s)} as a client cluster`}_getNodeName(e){const t=this._nodes.find(t=>t.node_id===e);return t?.name||`Node ${e}`}_getClusterName(e){return Te[e]||`Cluster 0x${e.toString(16)}`}async _submitSurvey(){this._surveySubmitting=!0;try{await this.hass.callService("matter_binding_helper","submit_survey",{}),alert("Survey submitted successfully! Thank you for contributing.")}catch(e){this._error=`Failed to submit survey: ${e}`}finally{this._surveySubmitting=!1}}render(){return L`
    ...
    `}_renderEstablishedBindingRow(e){const{binding:t,sourceNode:i,sourceEndpoint:n,targetNode:o}=e,s=o?.name||`Node ${t.target_node_id}`,r=null!==t.target_group_id,a=Pe(t.cluster_id);return L`
    ...
    `}_renderEndpointItem(e){const t=this._selectedSourceEndpoint?.endpoint_id===e.endpoint_id,i=e.device_types.map(e=>Be(e.id)).filter(t=>0!==e.endpoint_id||!t.includes("Root")),n=[29,30,31,40,42,48,49,50,51,52,53,56,60,62,63,70],o=(e.server_clusters||[]).filter(e=>!n.includes(e)).map(e=>De(e)),s=(e.client_clusters||[]).filter(e=>!n.includes(e)).map(e=>De(e));return L`
      <div
        ...
        <div class="dialog confirm-dialog" @click=${e=>e.stopPropagation()}>
          ...
          <div class="binding-devices">
            ...
            <div class="binding-arrow-container">
              <span class="binding-cluster-label">${De(s)}</span>
    ...
    `}_renderDeleteConfirmDialog(){if(!this._pendingDeleteBinding)return F;const{binding:e,sourceNode:t,sourceEndpoint:i,targetNode:n}=this._pendingDeleteBinding,o=Pe(e.cluster_id),s=n?.name||`Node ${e.target_node_id}`,r=null!==this._actionInProgress,a=null!==e.target_group_id;return L`
