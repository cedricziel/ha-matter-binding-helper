 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const at={attribute:!0,type:String,converter:$,reflect:!1,hasChanged:f},dt=(t=at,e,i)=>{const{kind:s,metadata:o}=i;let n=globalThis.litPropertyMetadata.get(o);if(void 0===n&&globalThis.litPropertyMetadata.set(o,n=new Map),"setter"===s&&((t=Object.create(t)).wrapped=!0),n.set(i.name,t),"accessor"===s){const{name:s}=i;return{set(i){const o=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,o,t)},init(e){return void 0!==e&&this.C(s,void 0,t,e),e}}}if("setter"===s){const{name:s}=i;return function(i){const o=this[s];e.call(this,i),this.requestUpdate(s,o,t)}}throw Error("Unsupported decorator location: "+s)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function ct(t){return lt({...t,state:!0,attribute:!1})}const pt=6,ht=8,ut=768,gt=5,_t={[pt]:"On/Off",[ht]:"Level Control",[ut]:"Color Control",[gt]:"Scenes"},vt="matter_binding_helper";let bt=class extends nt{constructor(){super(...arguments),this.narrow=!1,this._nodes=[],this._selectedSourceNode=null,this._selectedSourceEndpoint=null,this._bindings=[],this._groups=[],this._loading=!1,this._error=null,this._activeTab="bindings",this._showCreateDialog=!1}firstUpdated(){this._loadNodes()}async _loadNodes(){this._loading=!0,this._error=null;try{const t=await async function(t){return t.callWS({type:`${vt}/list_nodes`})}(this.hass);this._nodes=t.nodes}catch(t){this._error=`Failed to load nodes: ${t}`}finally{this._loading=!1}}async _loadBindings(){if(this._selectedSourceNode&&this._selectedSourceEndpoint){this._loading=!0;try{const t=await async function(t,e,i){return t.callWS({type:`${vt}/list_bindings`,node_id:e,endpoint_id:i})}(this.hass,this._selectedSourceNode.node_id,this._selectedSourceEndpoint.endpoint_id);this._bindings=t.bindings}catch(t){this._error=`Failed to load bindings: ${t}`}finally{this._loading=!1}}}async _loadGroups(){this._loading=!0;try{const t=await async function(t){return t.callWS({type:`${vt}/list_groups`})}(this.hass);this._groups=t.groups}catch(t){this._error=`Failed to load groups: ${t}`}finally{this._loading=!1}}_selectNode(t){this._selectedSourceNode?.node_id===t.node_id?(this._selectedSourceNode=null,this._selectedSourceEndpoint=null,this._bindings=[]):(this._selectedSourceNode=t,this._selectedSourceEndpoint=null,this._bindings=[])}_selectEndpoint(t){t.has_binding_cluster&&(this._selectedSourceEndpoint=t,this._loadBindings())}async _deleteBinding(t){if(confirm("Are you sure you want to delete this binding?"))try{await async function(t,e,i,s,o,n){return t.callWS({type:`${vt}/delete_binding`,source_node_id:e,source_endpoint_id:i,...void 0!==s&&{target_node_id:s},...void 0!==o&&{target_endpoint_id:o},...void 0!==n&&{target_group_id:n}})}(this.hass,t.node_id,t.endpoint_id,t.target_node_id??void 0,t.target_endpoint_id??void 0,t.target_group_id??void 0),await this._loadBindings()}catch(t){this._error=`Failed to delete binding: ${t}`}}_openCreateDialog(){this._showCreateDialog=!0}_closeCreateDialog(){this._showCreateDialog=!1}async _handleCreateBinding(t){t.preventDefault();const e=t.target,i=new FormData(e),s=parseInt(i.get("targetNode"),10),o=parseInt(i.get("targetEndpoint"),10),n=parseInt(i.get("cluster"),10);if(this._selectedSourceNode&&this._selectedSourceEndpoint)try{await async function(t,e,i,s,o,n,r){return t.callWS({type:`${vt}/create_binding`,source_node_id:e,source_endpoint_id:i,cluster_id:s,...void 0!==o&&{target_node_id:o},...void 0!==n&&{target_endpoint_id:n},...void 0!==r})}(this.hass,this._selectedSourceNode.node_id,this._selectedSourceEndpoint.endpoint_id,n,s,o),this._closeCreateDialog(),await this._loadBindings()}catch(t){this._error=`Failed to create binding: ${t}`}}_getNodeName(t){const e=this._nodes.find(e=>e.node_id===t);return e?.name||`Node ${t}`}_getClusterName(t){return _t[t]||`Cluster 0x${t.toString(16)}`}render(){return I`
    ...
    `}_renderNodeItem(t){const e=this._selectedSourceNode?.node_id===t.node_id,i=t.endpoints.filter(t=>t.has_binding_cluster),s=t.endpoints.length,o=t.device_info;return I`
      <li>
        <div
        ...
        >
          ...
          <div class="node-info">
            ...
            <div class="node-meta">
              ${t.area_name?I`<span class="node-area">${t.area_name}</span>`:o?.vendor_name?I`<span class="node-vendor">${o.vendor_name}</span>`:W}
              <span class="node-endpoints ${i.length>0?"has-binding":""}">
                ${s>0?i.length>0?`${i.length}/${s} bindable`:`${s} ep`:"no endpoints"}
              </span>
            </div>
          </div>
        </div>
        ${e?I`
              <div class="node-details">
                ${o?.software_version?I`<span class="node-version">v${o.software_version}</span>`:W}
                ${s>0?I`
                      <div class="endpoint-list">
                        ${t.endpoints.map(t=>this._renderEndpointItem(t))}
                      </div>
                    `:I`<div class="no-endpoints">No endpoints found</div>`}
              </div>
            `:W}
      </li>
  ...
  `,t([lt({attribute:!1})],bt.prototype,"hass",void 0),t([lt({type:Boolean})],bt.prototype,"narrow",void 0),t([ct()],bt.prototype,"_nodes",void 0),t([ct()],bt.prototype,"_selectedSourceNode",void 0),t([ct()],bt.prototype,"_selectedSourceEndpoint",void 0),t([ct()],bt.prototype,"_bindings",void 0),t([ct()],bt.prototype,"_groups",void 0),t([ct()],bt.prototype,"_loading",void 0),t([ct()],bt.prototype,"_error",void 0),t([ct()],bt.prototype,"_activeTab",void 0),t([ct()],bt.prototype,"_showCreateDialog",void 0),bt=t([(t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})("matter-binding-helper-panel")],bt);export{bt as MatterBindingPanel};
