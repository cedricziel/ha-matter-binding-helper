 ...
 */function ct(t){return lt({...t,state:!0,attribute:!1})}const pt=3,ht=4,ut=5,gt=6,_t=8,mt=29,vt=30,yt=31,bt=40,ft=47,$t=768,xt=513,St=516,At={[pt]:"Identify",[ht]:"Groups",[ut]:"Scenes",[gt]:"On/Off",[_t]:"Level Control",[mt]:"Descriptor",[vt]:"Binding",[yt]:"Access Control",[bt]:"Basic Information",42:"OTA Update",[ft]:"Power Source",48:"General Commissioning",49:"Network Commissioning",50:"Diagnostic Logs",51:"General Diagnostics",52:"Software Diagnostics",53:"Thread Diagnostics",56:"Ethernet Diagnostics",60:"Admin Commissioning",62:"Operational Credentials",63:"Group Key Management",70:"Time Sync",[$t]:"Color Control",[xt]:"Thermostat",[St]:"Thermostat UI",514:"Fan Control"},wt={17:"Power Source",18:"OTA Requestor",19:"OTA Provider",20:"Aggregator",22:"Root Node",256:"On/Off Light",257:"Dimmable Light",258:"Color Temperature Light",259:"On/Off Light Switch",260:"Dimmer Switch",261:"Color Dimmer Switch",262:"Light Sensor",263:"Occupancy Sensor",266:"On/Off Plug-in Unit",267:"Dimmable Plug-in Unit",268:"Color Temperature Light",269:"Extended Color Light",769:"Thermostat",770:"Temperature Sensor",771:"Humidity Sensor",772:"Air Quality Sensor",10:"Door Lock",11:"Door Lock Controller",514:"Window Covering",515:"Window Covering Controller",21:"Contact Sensor",38:"Flow Sensor",44:"Smoke/CO Alarm",35:"Casting Video Player",36:"Content App",40:"Basic Video Player",41:"Casting Video Client",43:"Speaker"};function Et(t){return wt[t]||`Type ${t}`}const Ct="matter_binding_helper";let kt=class extends nt{constructor(){super(...arguments),this.narrow=!1,this._nodes=[],this._selectedSourceNode=null,this._selectedSourceEndpoint=null,this._bindings=[],this._groups=[],this._loading=!1,this._error=null,this._activeTab="bindings",this._showCreateDialog=!1,this._surveySubmitting=!1}firstUpdated(){this._loadNodes()}async _loadNodes(){this._loading=!0,this._error=null;try{const t=await async function(t){return t.callWS({type:`${Ct}/list_nodes`})}(this.hass);this._nodes=t.nodes}catch(t){this._error=`Failed to load nodes: ${t}`}finally{this._loading=!1}}async _loadBindings(){if(this._selectedSourceNode&&this._selectedSourceEndpoint){this._loading=!0;try{const t=await async function(t,e,i){return t.callWS({type:`${Ct}/list_bindings`,node_id:e,endpoint_id:i})}(this.hass,this._selectedSourceNode.node_id,this._selectedSourceEndpoint.endpoint_id);this._bindings=t.bindings}catch(t){this._error=`Failed to load bindings: ${t}`}finally{this._loading=!1}}}async _loadGroups(){this._loading=!0;try{const t=await async function(t){return t.callWS({type:`${Ct}/list_groups`})}(this.hass);this._groups=t.groups}catch(t){this._error=`Failed to load groups: ${t}`}finally{this._loading=!1}}_selectNode(t){this._selectedSourceNode?.node_id===t.node_id?(this._selectedSourceNode=null,this._selectedSourceEndpoint=null,this._bindings=[]):(this._selectedSourceNode=t,this._selectedSourceEndpoint=null,this._bindings=[])}_selectEndpoint(t,e){t.stopPropagation(),e.has_binding_cluster&&(this._selectedSourceEndpoint=e,this._loadBindings())}async _deleteBinding(t){if(confirm("Are you sure you want to delete this binding?"))try{await async function(t,e,i,o,s,n){return t.callWS({type:`${Ct}/delete_binding`,source_node_id:e,source_endpoint_id:i,...void 0!==o&&{target_node_id:o},...void 0!==s&&{target_endpoint_id:s},...void 0!==n&&{target_group_id:n}})}(this.hass,t.node_id,t.endpoint_id,t.target_node_id??void 0,t.target_endpoint_id??void 0,t.target_group_id??void 0),await this._loadBindings()}catch(t){this._error=`Failed to delete binding: ${t}`}}_openCreateDialog(){this._showCreateDialog=!0}_closeCreateDialog(){this._showCreateDialog=!1}async _handleCreateBinding(t){t.preventDefault();const e=t.target,i=new FormData(e),o=parseInt(i.get("targetNode"),10),s=parseInt(i.get("targetEndpoint"),10),n=parseInt(i.get("cluster"),10);if(this._selectedSourceNode&&this._selectedSourceEndpoint)try{await async function(t,e,i,o,s,n,r){return t.callWS({type:`${Ct}/create_binding`,source_node_id:e,source_endpoint_id:i,cluster_id:o,...void 0!==s&&{target_node_id:s},...void 0!==n&&{target_endpoint_id:n},...void 0!==r})}(this.hass,this._selectedSourceNode.node_id,this._selectedSourceEndpoint.endpoint_id,n,o,s),this._closeCreateDialog(),await this._loadBindings()}catch(t){this._error=`Failed to create binding: ${t}`}}_getNodeName(t){const e=this._nodes.find(e=>e.node_id===t);return e?.name||`Node ${t}`}_getClusterName(t){return At[t]||`Cluster 0x${t.toString(16)}`}async _submitSurvey(){this._surveySubmitting=!0;try{await this.hass.callService("matter_binding_helper","submit_survey",{}),alert("Survey submitted successfully! Thank you for contributing.")}catch(t){this._error=`Failed to submit survey: ${t}`}finally{this._surveySubmitting=!1}}render(){return L`
    ...
    `}_renderEndpointItem(t){const e=this._selectedSourceEndpoint?.endpoint_id===t.endpoint_id,i=t.device_types.map(t=>Et(t.id)).filter(e=>0!==t.endpoint_id||!e.includes("Root")),o=[29,31,40,42,48,49,50,51,52,53,56,60,62,63,70],s=t.clusters.filter(t=>!o.includes(t)).map(t=>{return At[e=t]||`0x${e.toString(16).padStart(4,"0")}`;var e});return L`
      <div
  ...
  `,t([lt({attribute:!1})],kt.prototype,"hass",void 0),t([lt({type:Boolean})],kt.prototype,"narrow",void 0),t([ct()],kt.prototype,"_nodes",void 0),t([ct()],kt.prototype,"_selectedSourceNode",void 0),t([ct()],kt.prototype,"_selectedSourceEndpoint",void 0),t([ct()],kt.prototype,"_bindings",void 0),t([ct()],kt.prototype,"_groups",void 0),t([ct()],kt.prototype,"_loading",void 0),t([ct()],kt.prototype,"_error",void 0),t([ct()],kt.prototype,"_activeTab",void 0),t([ct()],kt.prototype,"_showCreateDialog",void 0),t([ct()],kt.prototype,"_surveySubmitting",void 0),kt=t([(t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})("matter-binding-helper-panel")],kt);export{kt as MatterBindingPanel};
