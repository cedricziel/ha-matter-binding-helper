        ...
        <div class="binding-description">
          <div class="binding-sentence">
            ...
            <span class="cluster-badges">
              ${s.map(e=>{const t=We(e),i=`${t}: ${Ke(e).dataType}`;return j`<span class="cluster-badge" title="${i}">${t}</span>`})}
            </span>
          </div>
          <div class="binding-meta">
            ...
            <div class="form-group">
              ...
              ${n.length>0?j`
                    <select name="cluster" class="form-select" required>
                      ${n.map(e=>{const t=We(e),i=Ke(e);return j`
